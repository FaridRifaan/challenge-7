...
class MoviePopularTest{
    ...
    @After
    fun teardown() {
        // Membersihkan semua resource setelah penguijian
    }
    ...
    fun testListMovieDeserialization() {
        ...
        // Melakukan deserialisasi dari JSON ke objek MoviePopular menggunakan Gson
        val listMovie = gson.fromJson(json, MoviePopular::class.java)
